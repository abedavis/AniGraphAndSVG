...
- `model.material`([AMaterial](../../gl-rendering/material/AMaterial.ts)): the material used to render the model. If you implement a custom shader, it will take the form of a material.
