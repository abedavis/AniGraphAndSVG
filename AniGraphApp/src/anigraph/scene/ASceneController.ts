...
import {AGLContext, AGLRenderWindow} from "../gl-rendering";
...
import {ARenderTarget} from "../gl-rendering/target/ARenderTarget";
...
import {ARenderContext} from "../gl-rendering/context/ARenderContext";
import {ARenderWindow} from "../gl-rendering/context/ARenderWindow";
...
export abstract class ASceneController extends AController implements HasModelViewMap, SceneControllerInterface{
    ...
    onWindowResize(renderWindow?: ARenderWindow): void {
        if(renderWindow && renderWindow.container !== undefined) {
            this.renderer.setSize(renderWindow.clientWidth, renderWindow.clientHeight);
            /**
