...
import {DepthBufferSceneConstants, DepthBufferDemoSceneModel} from "./DepthBufferDemoSceneModel";
...
import {MyCustomInteractionMode} from "../MultipassExample/MyCustomInteractionMode";
import {CustomInteractionModeWithRightClick} from "./CustomInteractionModeWithRightClick";
...
export class DepthBufferDemoSceneController extends ExampleSceneController{



    get model():DepthBufferDemoSceneModel{
        return this._model as DepthBufferDemoSceneModel;
    }
    ...
    initModelViewSpecs(): void {
         ...
         * @type {ASceneView}
         */
        let pass2view = this.getSceneView(DepthBufferSceneConstants.POST_PROCESSING_PASS);
    ...
    initInteractions() {
        ...
        let myCustomRightClickInteractionMode = new CustomInteractionModeWithRightClick(this)
        this.defineInteractionMode(CustomInteractionModeWithRightClick.NameInGUI, myCustomRightClickInteractionMode);
    }
