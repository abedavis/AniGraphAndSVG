...
import {ATerrainShaderModel} from "../../../../anigraph/gl-rendering/shadermodels";


export class TerrainShaderModel extends ATerrainShaderModel{
    CreateMaterial(
         ...
         */
        let mat = super.CreateMaterial(diffuseTexture);
